...
/**
 * Aceternity UI — CanvasText
 * Animated text with colorful curved lines rendered on canvas, clipped to the text shape.
...
export function CanvasText({
  ...
  return (
    ...
    >
      <span ref={textRef} className="invisible inline-block whitespace-nowrap">
        {text}
      </span>
      <canvas
        ref={canvasRef}
