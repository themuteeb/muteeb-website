...
export const ThoughtsSection: React.FC<ThoughtsProps> = ({ thoughts, onLikeThought }) => {
  ...
  const defaultThoughts: Thought[] = [
    {
      id: 1,
      title: 'BUILDING MY PERSONAL WEBSITE: DESIGN & TECH CHOICES',
      slug: 'building-my-personal-website',
      summary: 'Reflections on designing and building my personal space with high-contrast typography, React 19, and Tailwind v4.',
      content: `Welcome to my personal website! I wanted a digital space that felt distinct, clean, and memorable.\n\nWhy High-Contrast Neo-Brutalism?\n1. Bold typography makes reading effortless.\n2. Sharp borders and dark mode give it a confident, clean feel.\n3. Interactive sound effects and customizable neon accent palettes add a touch of personality.\n\nBuilding this with React 19, Tailwind CSS v4, and Supabase was a blast. I'll be sharing more thoughts and personal project updates right here!`,
    ...
    },
    {
      ...
      slug: 'my-favorite-developer-tools-2025',
      summary: 'A rundown of the editor, frameworks, and utilities I use daily to build personal projects efficiently.',
      content: `Over the past year, my developer setup has evolved to focus on speed, simplicity, and flow. Here are the core tools I rely on every day:\n\n- Vite + React: For instant HMR and quick prototyping.\n- Tailwind CSS: Allows rapid styling without leaving the component file.\n- Supabase: Instant Postgres database with real-time support.\n- VS Code: Fast keyboard-driven workflow.\n\nKeeping my stack lightweight lets me spend more time building and less time configuring build pipelines.`,
      tags: ['DEVELOPER TOOLS', 'WORKFLOW', 'TECH'],
  ...
  const displayList = thoughts.length > 0 ? thoughts : defaultThoughts;
